                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Unit of Measurements</h3>
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="#" data-target="addProduct" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Uom</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="card-inner-group">
                                ...
                                <div class="nk-tb-list">
                                    ...
                                    @foreach ($uoms as $uom)
                                        <div class="nk-tb-item">
                                            <div class="nk-tb-col nk-tb-col-check">
                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                    <input type="checkbox" class="custom-control-input" id="{{$uom->id}}">
                                                    <label class="custom-control-label" for="{{$uom->id}}"></label>
                                                </div>
                                            </div>
                                            <div class="nk-tb-col">
                                                <span class="tb-product">
                                                    <span class="title">{{$uom->name}}</span>
                                                </span>
                                            </div>
                                            <div class="nk-tb-col">
                                                <span class="tb-sub">{{$uom->description}}</span>
                                            </div>
                            ...
                            <div class="card-inner">
                                <div class="nk-block-between-md g-3">
                                    <div class="g">
                                        {{$uoms->links('dashlite.layouts.pagination')}}
                                        <!-- .pagination -->
                                    </div>
                                    <div class="g">
                                        <!-- TODO -->
