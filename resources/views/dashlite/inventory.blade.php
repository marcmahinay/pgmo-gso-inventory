                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list">
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <span class="tb-sub">pc</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-sub tb-col-sm">49</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-lead tb-col-sm">$ 99.49</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-lead">$ 4,875.01</span>
                                        </div>
                                        <div class="nk-tb-col">
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col">
                                            <span class="tb-lead">$9217.47</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-sub">20</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-md">
                                            <div class="asterisk tb-asterisk">
                                                <a href="#"><em class="asterisk-off icon ni ni-star"></em><em class="asterisk-on icon ni ni-star-fill"></em></a>
